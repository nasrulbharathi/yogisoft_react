...
describe("Gift_Actions", () => {
  ...
  it("should handle fetchCards action", async () => {
    axiosWrapper.get = jest
      .fn()
      .mockImplementation(() => Promise.resolve({ card: "carddata" }));
  ...
  it("should handle adminUpdateCard action", async () => {
    axiosWrapper.patch = jest
      .fn()
      .mockImplementation(() => Promise.resolve(getGiftCardData));
  ...
  it("should handle updateCardCount action", async () => {
    axiosWrapper.patch = jest
      .fn()
      .mockImplementation(() => Promise.resolve({ data: getGiftCardData }));
    const dispatch = jest.fn().mockImplementation((args) => {});
