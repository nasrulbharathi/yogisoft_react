...
export const updateUserBalance = (id, newBalance) => async (dispatch) => {
  const response = await axiosWrapper.patch(`/users/${id}`, {
...
export const updateTransact = (TransactObj) => async (dispatch) => {
  const response = await axiosWrapper.post("/giftTransact", TransactObj);
  dispatch({
